...
/*	for (int i = 0; i< NUMBER_OF_AXIS; i++ )
	...
	for (int i = 0; i< NUMBER_OF_AXIS; i++ )
	{
		dtwLeft[i] = new DTW(left20[i], acc[i]);
		//System.out.println(dtwLeft[i]);
		dtw[0][i] = dtwLeft[i] ;
	}
	...
	for (int i = 0; i< NUMBER_OF_AXIS; i++ )
	{
		dtwDown[i] = new DTW(down20[i], acc[i]);
	//	System.out.println(dtwDown[i]);
		dtw[1][i] = dtwDown[i];
	}
	...
	for (int i = 0; i< NUMBER_OF_AXIS; i++ )
	{
		dtwRight[i] = new DTW(right20[i], acc[i]);
	//	System.out.println(dtwRight[i]);
		dtw[2][i] = dtwRight[i];
	}
	...
	for (int i = 0; i< NUMBER_OF_AXIS; i++ )
	{
		dtwForward[i] = new DTW(forward20[i], acc[i]);
	//	System.out.println(dtwForward[i]);
		dtw[4][i] = dtwForward[i];
	}
	
	//System.out.println("Backwards");
	for (int i = 0; i< NUMBER_OF_AXIS; i++ )
	{
		dtwBackward[i] = new DTW(backward20[i], acc[i]);
	//	System.out.println(dtwBackward[i]);
		dtw[5][i] = dtwBackward[i];
	}
	
	//System.out.println("ConDown");
	for (int i = 0; i< NUMBER_OF_AXIS; i++ )
	{
		dtwConDown[i] = new DTW(conDown20[i], acc[i]);
	//	System.out.println(dtwConDown[i]);
		dtw[6][i] = dtwConDown[i];
	}
	
	//System.out.println("ConDownRight");
	
	for (int i = 0; i< NUMBER_OF_AXIS; i++ )
	{
		dtwConDownRight3[i] = new DTW(conDownRight3[i], acc[i]);
	//	System.out.println(dtwConDownRight3[i]);
		dtw[7][i] = dtwConDownRight3[i];
	}
	
//System.out.println("semiCircleUp");
	
	for (int i = 0; i< NUMBER_OF_AXIS; i++ )
	{
		dtwsemiCircleUp[i] = new DTW(semiCircleUp[i], acc[i]);
	//	System.out.println(dtwsemiCircleUp[i]);
		dtw[8][i] = dtwsemiCircleUp[i];
	}
